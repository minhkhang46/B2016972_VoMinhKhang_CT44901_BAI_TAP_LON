               ...
               <div class="contact">
                  ...
                  <ul>
                     ...
                     <li class="phone">
                        ...
                        <a style="color: #000000;text-decoration: none;" href="tel:+84 56668888">  +84 88900989</a>
                     </li>
                     <li class="email">
                        <i class="fa-solid fa-envelope icon-email"></i>
                        <a style="color: #000000;text-decoration: none;" href="mailto:minhkhang@gmail.com">  minhkhang@gmail.com</a>
